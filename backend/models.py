...
class Shop(models.Model):
    ...
    filename = models.CharField(max_length=45, verbose_name='Имя файла')
...
class ProductInfo(models.Model):
    ...
    shop = models.ForeignKey(Shop, verbose_name='Магазин', related_name='product_infos', blank=True,
                             on_delete=models.CASCADE)
    name = models.CharField(max_length=45, verbose_name='Наименование продукта')
...
class OrderItem(models.Model):
    ...
    product = models.ForeignKey(Product, verbose_name='Информация о продукте', related_name='ordered_items',
                                blank=True,
                                on_delete=models.CASCADE)
    shop = models.ForeignKey(Shop, verbose_name='Магазин', related_name='order_item', blank=True,
                             on_delete=models.CASCADE)
    quantity = models.PositiveIntegerField(verbose_name='Количество')
